...
void my_qsort(void *lineptr[], int left, int right, const int reverse, int (*comp)(void *, void *));
...
void my_qsort(void *v[], int left, int right, const int reverse, int (*comp)(void *, void *))
{
    int i, last, cmp;
